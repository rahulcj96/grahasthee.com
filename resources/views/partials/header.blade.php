              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    ...
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Shop Three Column </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Shop Three Column Wide </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Shop Four Column </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Shop Four Column Wide </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Shop Six Column </a>
                    </li>
                    <li>
                      <a href="#" class="dropdown-item item-anchor">Shop Six Column Wide </a>
                    </li>
                    <li>
